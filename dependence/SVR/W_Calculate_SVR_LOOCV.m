function [w_Brain, model_All] = W_Calculate_SVR_LOOCV(Subjects_Data, Subjects_Scores, Pre_Method, C_Parameter, ResultantFolder,fold)
%
% Subject_Data:
%           m*n matrix
...
if nargin >= 5
    mkdir(strcat(ResultantFolder,'\Weights')) ;
    save([ResultantFolder filesep 'Weights' filesep 'w_Brain_fold_' num2str(fold) '.mat'], 'w_Brain');
end
